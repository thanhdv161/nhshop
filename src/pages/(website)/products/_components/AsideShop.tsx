import { star1, star2, star3, star4, star5 } from '@/components/icons'
        ...
        <div className="my-5 pt-5 border-y border-[#F4F4F4]"> 
          ...
          <div className="space-y-4 my-5">
            <div className="custom-checkbox flex items-center space-x-2"> 
              <input type="checkbox" />
              <label htmlFor=''><img src={star5} alt='' /></label>
            </div>
            <div className="custom-checkbox flex items-center space-x-2"> 
              <input type="checkbox" />
              <label htmlFor=''><img src={star4} alt='' /></label>
            </div>
            <div className="custom-checkbox flex items-center space-x-2"> 
              <input type="checkbox" />
              <label htmlFor=''><img src={star3} alt='' /></label>
            </div>
            <div className="custom-checkbox flex items-center space-x-2"> 
              <input type="checkbox" />
              <label htmlFor=''><img src={star2} alt='' /></label>
            </div>
            <div className="custom-checkbox flex items-center space-x-2"> 
              <input type="checkbox" />
              <label htmlFor=''><img src={star1} alt='' /></label>
            </div>
          </div>
        </div>
        <div>
