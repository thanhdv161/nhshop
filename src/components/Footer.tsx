    ...
    <div className="container">
      <div className="bg-[#05422C] lg:h-[458px] rounded-3xl p-6 lg:p-[64px]">
        ...
        <form className="lg:flex items-center lg:space-x-8">
          ...
          <button className="bg-primary rounded-full text-white inline-block text-base/[150%] transition ease-in-out duration-300  py-4 px-4 lg:py-6 lg:w-[200px] hover:bg-green-700 hover:shadow-md lg:mt-0 mt-3 w-full">Reveal coupon</button>
        </form>
      </div>
    </div>
  </section>
