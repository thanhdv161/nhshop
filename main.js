...
// const largeSlide = document.querySelector('.large-slide');

// function exportSlide() {
//     overlay.classList.add('show');
//     largeSlide.classList.add('open');
//     document.body.classList.add('lock-scroll'); // Khóa cuộn trang
// }

// function importSlide() {
//     overlay.classList.remove('show');
//     largeSlide.classList.remove('open');
//     document.body.classList.remove('lock-scroll'); // Mở khóa cuộn trang
// }

// exportBtns.forEach(btn => btn.addEventListener('click', exportSlide));
// overlay.addEventListener('click', importSlide);
// importBtns.forEach(btn => btn.addEventListener('click', importSlide));
